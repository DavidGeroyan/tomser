  ...
  <div class="section trending">
    <div class="container">
      <ul class="trending-filter">
        ...
        <li>
          <a href="#!" data-filter=".adv">Comedy</a>
        </li>
        <li>
          <a href="#!" data-filter=".str">Horror</a>
        </li>
        <li>
          <a href="#!" data-filter=".rac">Family</a>
        </li>
        <li>
          <a href="#!" data-filter=".dra">drama</a>
        </li>
      ...
      <div class="row trending-box">
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 adv rac">
          <div class="item">
            ...
            <div class="down-content">
              <span class="category">Action, Adventure, Fantasy, <br>Motion</span>
              <h4>THE MARVELS</h4>
              <a href="product-details.php"><i class="fa fa-shopping-bag"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 align-self-left mb-30 trending-items col-md-6 str">
          <div class="item">
            <div class="thumb">
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 dra">
          <div class="item">
            <div class="thumb">
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 rac">
          <div class="item">
            <div class="thumb">
              <a href="product-details.php"><img src="https://cdn.center.am/xdKVPHSxxyh5mntBju1bj4cGsLGuViNL03SBMCv9rZY/rs:auto:0:0:0/g:no/czM6Ly9jaW5lbWEvNDQ0NC93aXNocG9ydGFybS5qcGc.jpg?width=430&height=641" alt=""></a>
              <span class="price"><em>2800AMD</em>2200AMD</span>
            </div>
            <div class="down-content">
              <span class="category">Animation, Family <br><br></span>
              <h4>WISH</h4>
              <a href="product-details.php"><i class="fa fa-shopping-bag"></i></a>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6">
          <div class="item">
            <div class="thumb">
              <a href="product-details.php"><img src="https://cdn.center.am/roVIbZcVSXY4qKAi1IqMb78QsbBRWk-k45a7Z4WVbMI/rs:auto:0:0:0/g:no/czM6Ly9jaW5lbWEvNDQzNC9iZXlvbmNlcG9ydC5qcGc.jpg?width=430&height=641" alt=""></a>
              <span class="price">3600AMD</span>
            </div>
            <div class="down-content">
              <span class="category">Documentary film, Music</span>
              <h4>RENAISSANCE: A FILM BY BEYONCÉ</h4>
              <a href="product-details.php"><i class="fa fa-shopping-bag"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 adv">
          <div class="item">
            <div class="thumb">
              ...
              <span class="price"><em>3600AMD</em>2750AMD</span>
            </div>
            <div class="down-content">
              <span class="category">Comedy, Adventure</span>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 rac">
          <div class="item">
            <div class="thumb">
              <a href="product-details.php"><img src="https://cdn.center.am/Un5nsUDLQ7yML21SyKKzJs9P8Ij91kFkrtGO--Uclb8/rs:auto:0:0:0/g:no/czM6Ly9jaW5lbWEvNDQ1MC9Qb255aGVyetC_0L7RgNGCLmpwZw.jpg?width=430&height=641" alt=""></a>
              <span class="price"><em>3600AMD</em>2200AMD</span>
            </div>
            <div class="down-content">
              <span class="category">Animation, Adventure <br><br></span>
              <h4>PONYHERZ</h4>
              <a href="product-details.php"><i class="fa fa-shopping-bag"></i></a>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 str">
          <div class="item">
            ...
            <div class="down-content">
              <span class="category">Horror <br><br></span>
              <h4>THE PIPER</h4>
              <a href="product-details.php"><i class="fa fa-shopping-bag"></i></a>
            </div>
          </div>
